...
if yes_plot_devs
  ...
  for ipert = 1:nperts
    hax(nhf,ipert) = subplot(2,1,ipert);
    hpl = plot(frame_taxis(idxes4anal),patient_perttrial{ipert}.devmean(idxes4anal),'b');
    hold on
    hpl = plot(frame_taxis(idxes4anal),control_perttrial{ipert}.devmean(idxes4anal),'r');
    
    hpl = plot(frame_taxis(idxes4anal),patient_perttrial{ipert}.devmean(idxes4anal) + patient_perttrial{ipert}.devstde(idxes4anal),'b');
    hpl = plot(frame_taxis(idxes4anal),patient_perttrial{ipert}.devmean(idxes4anal) - patient_perttrial{ipert}.devstde(idxes4anal),'b');
    hpl = plot(frame_taxis(idxes4anal),control_perttrial{ipert}.devmean(idxes4anal) + control_perttrial{ipert}.devstde(idxes4anal),'r');
    hpl = plot(frame_taxis(idxes4anal),control_perttrial{ipert}.devmean(idxes4anal) - control_perttrial{ipert}.devstde(idxes4anal),'r');
    a = axis; axis([tlims4anal a(3:4)]);
  end
end
